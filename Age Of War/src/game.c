                ...
                switch (g->p1->level) {
                    case 1:
                        if (g->p1->money >= 100) {
                            ...
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 10, "d1_1_l", 100, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -100);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 2:
                        if (g->p1->money >= 500) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 20, "d2_1_l", 500, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -500);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 3:
                        if (g->p1->money >= 1500) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 40, "d3_1_l", 1500, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -1500);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 4:
                        if (g->p1->money >= 7000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 120, "d4_1_l", 7000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -7000);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 5:
                        if (g->p1->money >= 24000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 360, "d5_1_l", 24000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -24000);
                            setNumber(g->p1->no_money, g->p1->money);
                ...
                switch (g->p1->level) {
                    case 1:
                        if (g->p1->money >= 200) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 15, "d1_2_l", 200, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -200);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 2:
                        if (g->p1->money >= 750) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 30, "d2_2_l", 750, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -750);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 3:
                        if (g->p1->money >= 3000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 60, "d3_2_l", 3000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -3000);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 4:
                        if (g->p1->money >= 9000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 180, "d4_2_l", 9000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -9000);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 5:
                        if (g->p1->money >= 40000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 540, "d5_2_l", 40000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -40000);
                            setNumber(g->p1->no_money, g->p1->money);
                ...
                switch (g->p1->level) {
                    case 1:
                        if (g->p1->money >= 500) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 20, "d1_3_l", 500, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -500);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 2:
                        if (g->p1->money >= 1000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 40, "d2_3_l", 1000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -1000);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 3:
                        if (g->p1->money >= 6000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 80, "d3_3_l", 6000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -6000);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 4:
                        if (g->p1->money >= 14000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 240, "d4_3_l", 14000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                            setMoney(g->p1, -14000);
                            setNumber(g->p1->no_money, g->p1->money);
                    ...
                    case 5:
                        if (g->p1->money >= 100000) {
                            new_pos = newPosDefense(g->p1);
                            Defense *d = InitDefense(g->p1->slots_defenses[new_pos]->x + 10,
                                                     g->p1->slots_defenses[new_pos]->y + 15, 720, "d5_3_l", 100000, 1,
                                                     g->p1->defense_current_range);
                            addDefenses(g->p1, d);
                    ...
                    if (g->p1->experience >= EXP_MIN_LEVEL2) {
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 53,
                                                g->p1->slots_defenses[count_slots - 1]->y - 65);
                                        break;
                                    case 2:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 53,
                                                g->p1->slots_defenses[count_slots - 1]->y - 30);
                                        break;
                                    case 1:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 53,
                                                g->p1->slots_defenses[count_slots - 1]->y - 20);
                                        break;
                                }
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 53,
                                                g->p1->slots_defenses[count_slots - 1]->y - 90);
                                        break;
                                    case 2:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 53,
                                                g->p1->slots_defenses[count_slots - 1]->y - 85);
                                        break;
                                    case 1:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 53,
                                                g->p1->slots_defenses[count_slots - 1]->y - 55);
                                        break;
                                }
                    ...
                    if (g->p1->experience >= EXP_MIN_LEVEL4) {
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 57,
                                                g->p1->slots_defenses[count_slots - 1]->y - 40);
                                        break;
                                    case 2:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 57,
                                                g->p1->slots_defenses[count_slots - 1]->y - 25);
                                        break;
                                    case 1:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 33,
                                                g->p1->slots_defenses[count_slots - 1]->y - 33);
                                        break;
                                }
                    ...
                    if (g->p1->experience >= EXP_MIN_LEVEL5) {
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 77,
                                                g->p1->slots_defenses[count_slots - 1]->y - 75);
                                        break;
                                    case 2:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 77,
                                                g->p1->slots_defenses[count_slots - 1]->y - 38);
                                        break;
                                    case 1:
                                        setSlot(g->p1->slots_defenses[count_slots], buf, 75,
                                                g->p1->slots_defenses[count_slots - 1]->y - 18);
                                        break;
                                }
                ...
                switch (g->p2->level) {
                    case 1:
                        if (g->p2->money >= 100) {
                            ...
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 10, "d1_1_r", 100, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -100);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 2:
                        if (g->p2->money >= 500) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 20, "d2_1_r", 500, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -500);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 3:
                        if (g->p2->money >= 1500) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 40, "d3_1_r", 1500, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -1500);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 4:
                        if (g->p2->money >= 7000) {
                            ...
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 120, "d4_1_r", 7000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -7000);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 5:
                        if (g->p2->money >= 24000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 360, "d5_1_r", 24000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -24000);
                            setNumber(g->p2->no_money, g->p2->money);
                ...
                switch (g->p2->level) {
                    case 1:
                        if (g->p2->money >= 200) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 15, "d1_2_r", 200, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -200);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 2:
                        if (g->p2->money >= 750) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 30, "d2_2_r", 750, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -750);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 3:
                        if (g->p2->money >= 3000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 60, "d3_2_r", 3000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -3000);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 4:
                        if (g->p2->money >= 9000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 180, "d4_2_r", 9000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -9000);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 5:
                        if (g->p2->money >= 40000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 540, "d5_2_r", 40000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -40000);
                            setNumber(g->p2->no_money, g->p2->money);
                ...
                switch (g->p2->level) {
                    case 1:
                        if (g->p2->money >= 500) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 20, "d1_3_r", 500, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -500);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 2:
                        if (g->p2->money >= 1000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 40, "d2_3_r", 1000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -1000);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 3:
                        if (g->p2->money >= 6000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 80, "d3_3_r", 6000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -6000);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 4:
                        if (g->p2->money >= 14000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 240, "d4_3_r", 14000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                            setMoney(g->p2, -14000);
                            setNumber(g->p2->no_money, g->p2->money);
                    ...
                    case 5:
                        if (g->p2->money >= 100000) {
                            new_pos = newPosDefense(g->p2);
                            Defense *d = InitDefense(g->p2->slots_defenses[new_pos]->x - 10,
                                                     g->p2->slots_defenses[new_pos]->y + 15, 720, "d5_3_r", 100000, 2,
                                                     g->p2->defense_current_range);
                            addDefenses(g->p2, d);
                    ...
                    if (g->p2->experience >= EXP_MIN_LEVEL2) {
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 971,
                                                g->p2->slots_defenses[count_slots - 1]->y - 65);
                                        break;
                                    case 2:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 971,
                                                g->p2->slots_defenses[count_slots - 1]->y - 30);
                                        break;
                                    case 1:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 971,
                                                g->p2->slots_defenses[count_slots - 1]->y - 20);
                                        break;
                                }
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 971,
                                                g->p2->slots_defenses[count_slots - 1]->y - 90);
                                        break;
                                    case 2:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 971,
                                                g->p2->slots_defenses[count_slots - 1]->y - 85);
                                        break;
                                    case 1:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 971,
                                                g->p2->slots_defenses[count_slots - 1]->y - 55);
                                        break;
                                }
                    ...
                    if (g->p2->experience >= EXP_MIN_LEVEL4) {
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 947,
                                                g->p2->slots_defenses[count_slots - 1]->y - 40);
                                        break;
                                    case 2:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 947,
                                                g->p2->slots_defenses[count_slots - 1]->y - 25);
                                        break;
                                    case 1:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 971,
                                                g->p2->slots_defenses[count_slots - 1]->y - 33);
                                        break;
                                }
                        ...
                        if (count_slots > 0) {
                            while (count_slots > 0) {
                                ...
                                switch (count_slots) {
                                    case 3:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 947,
                                                g->p2->slots_defenses[count_slots - 1]->y - 75);
                                        break;
                                    case 2:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 947,
                                                g->p2->slots_defenses[count_slots - 1]->y - 38);
                                        break;
                                    case 1:
                                        setSlot(g->p2->slots_defenses[count_slots], buf, 949,
                                                g->p2->slots_defenses[count_slots - 1]->y - 18);
                                        break;
                                }
    ...
    if (!(emptyUnits(g->p1)) && emptyUnits(g->p2)) {
        ...
        while (counter < MAX_UNITS) {
            ...
            if (g->p1->units[counter] != NULL) {
                    ...
                    if (checkUnitTowerRange(g->p1->units[counter], g->p2->t)) {
                        ...
                        if (emptyBulletsUnits(g->p1->units[counter])) {
                            if (g->timer_cntr % 60 == 0) {
                                ...
                                Bullet *b = InitBullet(g->p1->units[counter]->x + g->p1->units[counter]->width,
                                                       g->p1->units[counter]->y + 18, g->p1->units[counter]->strength,
                                                       1, 2, "bullet");
                        ...
                        if (checkUnitsDefenseRange(g->p1->units[0], g->p2->defenses[defense_counter])) {
                            ...
                            if (emptyBulletsDefenses(g->p2->defenses[defense_counter])) {
                                ...
                                if (g->timer_cntr % 60 == 0) {
                                    ...
                                    Bullet *b = InitBullet(g->p2->defenses[defense_counter]->x -
                                                           g->p2->defenses[defense_counter]->width,
                                                           g->p2->defenses[defense_counter]->y +
                                                           (g->p2->defenses[defense_counter]->height / 2),
                                                           g->p2->defenses[defense_counter]->strength, 2, 1, "bullet");
                                    addBulletsDefense(g->p2->defenses[defense_counter], b);
                                }
                            } else {
                                if (!checkBulletsUnitsCollision(g->p2->defenses[defense_counter]->bullets[0],
                                                                g->p1->units[0])) {


                                    moveBullet(g->p2->defenses[defense_counter]->bullets[0],
                                               g->p2->defenses[defense_counter]->bullets[0]->x - g->p1->units[0]->x +
                                               g->p1->units[0]->width,
                                               InY - g->p2->defenses[defense_counter]->bullets[0]->y);
                                } else {
                                    ...
                                    if (g->p1->units[0]->UnitS == dying) {
                                        ...
                                        unitSetHP(g->p1->units[0], g->p1->units[0]->hp -
                                                                   g->p2->defenses[defense_counter]->bullets[0]->strength);
                ...
                if ((g->p1->units[0] != NULL) && (g->p1->units[counter] != NULL) &&
                    (g->p1->units[counter]->UnitS != dying)) {
                        ...
                        if (counter != 0) {
                            if (g->p1->units[counter]->type == 1) {
                                if (g->p1->units[counter]->UnitS != shooting) {
                                    if (!checkUnitCollisionSamePlayer(g->p1->units[counter], g->p1->units[counter - 1],
                                                                      1)) {
                                ...
                                if (g->p1->units[counter - 1]->type == 1 &&
                                    (g->p1->units[counter - 1]->UnitS == shooting ||
                                     g->p1->units[counter - 1]->UnitS == standing)) {
                                    if (checkUnitCollisionSamePlayer(g->p1->units[counter], g->p1->units[counter - 1],
                                                                     1)) {
                                        g->p1->units[counter]->UnitS = moving;
                                        MoveUnit(g->p1->units[counter]);
        ...
        if (emptyUnits(g->p1) && !(emptyUnits(g->p2))) {
            ...
            while (counter < MAX_UNITS) {
                if (g->p2->units[counter] != NULL) {
                    ...
                    if ((g->p2->units[counter]->type == 1)) {
                        if (checkUnitTowerRange(g->p2->units[counter], g->p1->t)) {
                            ...
                            if (emptyBulletsUnits(g->p2->units[counter])) {
                                if (g->timer_cntr % 60 == 0) {
                                    Bullet *b = InitBullet(g->p2->units[counter]->x - g->p2->units[counter]->width,
                                                           g->p2->units[counter]->y + 18,
                                                           g->p2->units[counter]->strength, 2, 2, "bullet");
                            ...
                            if (checkUnitsDefenseRange(g->p2->units[0], g->p1->defenses[defense_counter])) {
                                ...
                                if (emptyBulletsDefenses(g->p1->defenses[defense_counter])) {
                                    ...
                                    if (g->timer_cntr % 60 == 0) {
                                        ...
                                        Bullet *b = InitBullet(g->p1->defenses[defense_counter]->x +
                                                               g->p1->defenses[defense_counter]->width,
                                                               g->p1->defenses[defense_counter]->y +
                                                               (g->p1->defenses[defense_counter]->height / 2),
                                                               g->p1->defenses[defense_counter]->strength, 1, 1,
                                                               "bullet");
                                        addBulletsDefense(g->p1->defenses[defense_counter], b);
                                    }
                                } else {
                                    if (!checkBulletsUnitsCollision(g->p1->defenses[defense_counter]->bullets[0],
                                                                    g->p2->units[0])) {


                                        moveBullet(g->p1->defenses[defense_counter]->bullets[0],
                                                   g->p2->units[0]->x - g->p1->defenses[defense_counter]->bullets[0]->x,
                                                   InY - g->p1->defenses[defense_counter]->bullets[0]->y);
                                    } else {
                                        ...
                                        if (g->p2->units[0]->UnitS == dying) {
                                            ...
                                            unitSetHP(g->p2->units[0], g->p2->units[0]->hp -
                                                                       g->p1->defenses[defense_counter]->bullets[0]->strength);
                    ...
                    if ((g->p2->units[0] != NULL) && (g->p2->units[counter] != NULL) &&
                        (g->p2->units[counter]->UnitS != dying)) {
                            ...
                            if (counter != 0) {
                                if (g->p2->units[counter]->type == 1) {
                                    if (g->p2->units[counter]->UnitS != shooting) {
                                        if (!checkUnitCollisionSamePlayer(g->p2->units[counter],
                                                                          g->p2->units[counter - 1], 2)) {
                                    ...
                                    if (g->p2->units[counter - 1]->type == 1 &&
                                        (g->p2->units[counter - 1]->UnitS == shooting ||
                                         g->p2->units[counter - 1]->UnitS == standing)) {
                                        if (checkUnitCollisionSamePlayer(g->p2->units[counter],
                                                                         g->p2->units[counter - 1], 2)) {
                                            g->p2->units[counter]->UnitS = moving;
                                            MoveUnit(g->p2->units[counter]);
                ...
                while (counter < MAX_UNITS) {
                    ...
                    if (!(emptyUnits(g->p1)) && !(emptyUnits(g->p2))) {
                                    ...
                                    if (emptyBulletsDefenses(g->p2->defenses[defense_counter])) {
                                        ...
                                        if (g->timer_cntr % 60 == 0) {
                                            ...
                                            Bullet *b = InitBullet(g->p2->defenses[defense_counter]->x -
                                                                   ...
                                                                   g->p2->defenses[defense_counter]->y +
                                                                   (g->p2->defenses[defense_counter]->height / 2),
                                                                   g->p2->defenses[defense_counter]->strength, 2, 1,
                                                                   "bullet");
                                            addBulletsDefense(g->p2->defenses[defense_counter], b);
                                        }
                                    } else {
                                        if (!checkBulletsUnitsCollision(g->p2->defenses[defense_counter]->bullets[0],
                                            ...
                                            moveBullet(g->p2->defenses[defense_counter]->bullets[0],
                                                       g->p2->defenses[defense_counter]->bullets[0]->x -
                                                       g->p1->units[0]->x + g->p1->units[0]->width,
                                                       InY - g->p2->defenses[defense_counter]->bullets[0]->y);
                                        } else {
                                ...
                                if (checkUnitsDefenseRange(g->p2->units[0], g->p1->defenses[defense_counter])) {
                                    ...
                                    if (emptyBulletsDefenses(g->p1->defenses[defense_counter])) {
                                        ...
                                        if (!checkBulletsUnitsCollision(g->p1->defenses[defense_counter]->bullets[0],
                                            ...
                                            moveBullet(g->p1->defenses[defense_counter]->bullets[0],
                                                       g->p2->units[0]->x -
                                                       g->p1->defenses[defense_counter]->bullets[0]->x,
                                                       InY - g->p1->defenses[defense_counter]->bullets[0]->y);
                                        } else {
                        ...
                        if (g->p1->units[counter] != NULL && (g->p1->units[counter]->UnitS != dying)) {
                            ...
                            if ((g->p1->units[counter]->type == 1) &&
                                (checkUnitEnemyUnitRange(g->p1->units[counter], g->p2->units[0])) &&
                                !checkUnitCollision(g->p1->units[counter], g->p2->units[0])) {
                                ...
                                if (emptyBulletsUnits(g->p1->units[counter])) {
                                    ...
                                    if (g->timer_cntr % 60 == 0) {
                                        ...
                                        Bullet *b = InitBullet(g->p1->units[counter]->x + g->p1->units[counter]->width,
                                                               g->p1->units[counter]->y + 18,
                                                               g->p1->units[counter]->strength, 1, 2, "bullet");
                                        addBulletsUnits(g->p1->units[counter], b);
                                    }
                                } else {
                                    if (!checkBulletsUnitsCollision(g->p1->units[counter]->bullets[0],
                                                                    g->p2->units[0])) {
                                        ...
                                        if (g->p2->units[0]->UnitS == dying) {
                                            ...
                                            unitSetHP(g->p2->units[0], g->p2->units[0]->hp -
                                                                       g->p1->units[counter]->bullets[0]->strength);
                                            if (g->p2->units[0]->hp <= 0) {
                                                g->p2->units[0]->UnitS = dying;
                                            }
                                        }
                        ...
                        if (g->p2->units[counter] != NULL && (g->p2->units[counter]->UnitS != dying)) {
                            ...
                            if ((g->p2->units[counter]->type == 1) &&
                                (checkUnitEnemyUnitRange(g->p2->units[counter], g->p1->units[0])) &&
                                !checkUnitCollision(g->p2->units[counter], g->p1->units[0])) {
                                g->p2->units[counter]->UnitS = shooting;
                                if (emptyBulletsUnits(g->p2->units[counter])) {
                                    if (g->timer_cntr % 60 == 0) {
                                    ...
                                    if (!checkBulletsUnitsCollision(g->p2->units[counter]->bullets[0],
                                                                    g->p1->units[0])) {
                                        moveBullet(g->p2->units[counter]->bullets[0], 0, 0);
                                    } else {
                                        if (g->p1->units[0]->UnitS == dying) {
                                            ...
                                            unitSetHP(g->p1->units[0], g->p1->units[0]->hp -
                                                                       g->p2->units[counter]->bullets[0]->strength);
                                            if (g->p1->units[0]->hp <= 0) {
                                                g->p1->units[0]->UnitS = dying;
                                            }
                                        }
                        ...
                        if (g->p1->units[0] != NULL && g->p1->units[counter] != NULL &&
                            ...
                            if (counter != 0) {
                                if (g->p1->units[counter]->type == 1) {
                                    if (g->p1->units[counter]->UnitS != shooting) {
                                        if (!checkUnitCollisionSamePlayer(g->p1->units[counter],
                                                                          g->p1->units[counter - 1], 1)) {
                                            g->p1->units[counter]->UnitS = moving;
                                            MoveUnit(g->p1->units[counter]);
                                        } else {
                                            g->p1->units[counter]->UnitS = standing;
