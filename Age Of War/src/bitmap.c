...
void bitmap_draw_transparency(Bitmap *bmp, int x, int y, Alignment alignment, char *buffer) {
    ...
    for (i = 0; i < height; i++) {
        ...
        for (j = 0; j < width * 2; j++, bufferStartPos++) {
            ...
            if (temp != 0xF81F && temp != 0xD03A && temp != 0xB857 && temp != 0xB916 && temp != 0xC0D6 &&
                temp != 0xD85B && temp != 0xB133 && temp != 0xC897 && temp != 0xB151 && temp != 0xB171 &&
                temp != 0xB113 && temp != 0xE83C && temp != 0xD85A && temp != 0xC0B8 && temp != 0xA894 &&
                temp != 0xC839 && temp != 0xD89B && temp != 0xA951 && temp != 0xC098 && temp != 0xB195 &&
                temp != 0xE07B && temp != 0x9A2F && temp != 0x9A70 && temp != 0x9291 && temp != 0xF01E &&
                temp != 0xA931 && temp != 0x99D0 && temp != 0xB8B6 && temp != 0xA954 && temp != 0xB0F5 &&
                temp != 0xD079) { //Pink Color in RGB565
